    ...
    <div class="wrapper d-flex align-items w-100">
        <nav id="sidebar">
            ...
            <div class="p-4 pt-5">
                ...
                <ul class="list-unstyled components mb-5">
                    ...
                    <li>
                        <a href="{{ route('salesman') }}">Salesman</a>
                    </li>
                    <li>
                        <a href="{{ route('mainInvetory') }}">Inventory</a>
                    </li>
        ...
        <div id="content" class="p-5 pt-5">
            <div id="viewTable">
                ...
                <div id="dataTableDiv" class="upload-status mt-2 text-dark" style="font-size: 15px;">

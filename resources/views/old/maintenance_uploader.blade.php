...
<body>
                                ...
                                <div class="col mt-1">
                                    ...
                                    <div class="col h-50 mt-1">
                                        ...
                                        <textarea disabled class="form-control  bg-white" id="prdHighlight"
                                            placeholder="Highlight" rows="6" style="resize: none;"></textarea>
                                    </div>
                                </div>
                                <div class="col mt-1">
                                    ...
                                    <div class="col mt-2">
                                        ...
                                        <input disabled type="text" id="prdPrice" class="form-control bg-white"
                                            placeholder="Price">
                                    </div>
                                    ...
                                    <div class="col mt-2">
                                        ...
                                        <input disabled type="text" id="prdDescription" class="form-control bg-white"
                                            placeholder="Description">
                                    </div>
                                    <div class="col mt-2">
                                        <label for="prdMethod">Cooking Method</label>
                                        <input disabled type="text" id="prdMethod" class="form-control bg-white"
                                            placeholder="Application / Cooking Method">
                                    </div>
                                    <div class="col mt-2">
                                        <label for="prdWeight">Product Weight</label>
                                        <input disabled type="text" id="prdWeight" class="form-control bg-white"
                                            placeholder="Weight">
                                    </div>
                                    <div class="col mt-2">
                                        <label for="prdCaseConfig">Case Configuration</label>
                                        <input disabled type="text" id="prdCaseConfig" class="form-control bg-white"
                                            placeholder="Case Configuration">
                                    </div>
    ...
    <script src="{{ asset('assets/js/maintenance_uploader/masterlist_v3.js') }}"></script>
    <script src="{{ secure_asset('assets/js/maintenance_uploader/masterlist_v3.js') }}"></script>

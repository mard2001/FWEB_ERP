...
use App\Models\patarget_model;
use Illuminate\Http\Request;

class PATargetController
{

    public function index(Request $request)
    {
        try {
            $data = patarget_model::on($request->connectionName)->orderBy('id')->get();
        ...
        try {
            ...
            foreach ($data as $perRow) {
                ...
                try {
                    ...
                    patarget_model::on($request->connectionName)->insert($perRow);
                    $successfulInserts++;
                } catch (\Exception $e) {
    ...
    public function show(Request $request, string $id)
    {
        ...
        try {
            ...
            $data = patarget_model::on($request->connectionName)->find($id);
    ...
    public function update(Request $request, string $id)
    {
        ...
        try {
            ...
            $found = patarget_model::on($request->connectionName)->find($id);
    ...
    public function destroy(Request $request, string $id)
    {
        ...
        try {
            ...
            $data = patarget_model::on($request->connectionName)->where('id', $id)->delete();

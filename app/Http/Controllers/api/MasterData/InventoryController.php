...
class InventoryController
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            $data = inventory_model::on($request->connectionName)->orderBy('inventoryID')->get();
        ...
        try {
            ...
            foreach ($data as $perRow) {
                ...
                try {
                    ...
                    inventory_model::on($request->connectionName)->insert($perRow);
                    $successfulInserts++;
                } catch (\Exception $e) {
    ...
    public function show(Request $request, string $id)
    {
        ...
        try {
            ...
            $data = inventory_model::on($request->connectionName)->find($id);
    ...
    public function update(Request $request, string $id)
    {
        ...
        try {
            ...
            $found = inventory_model::on($request->connectionName)->find($id);
    ...
    public function destroy(Request $request, string $id)
    {
        ...
        try {
            ...
            $data = inventory_model::on($request->connectionName)->where('id', $id)->delete();
